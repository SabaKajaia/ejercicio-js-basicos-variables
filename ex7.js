...
Le encanta comer ${comidaFavorita} y tiene ${numJuguetes} juguetes diferentes. Necesita dormir al menos ${numHorasSueño} horas al día. Ahora mismo está jugando con su ${jugandoAhora}. ¡Es un gato muy feliz!`;
